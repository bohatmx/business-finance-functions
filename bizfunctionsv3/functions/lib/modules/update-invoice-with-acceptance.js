...
async function updateInvoice(mdata) {
    try {
        ...
        govtInvoice.invoiceAcceptance = `resource:com.oneconnect.biz.InvoiceAcceptance#${mdata.acceptanceId}`;
        await govtRef
            .collection("invoices")
        ...
        supplierInvoice.invoiceAcceptance = `resource:com.oneconnect.biz.InvoiceAcceptance#${mdata.acceptanceId}`;
...
//# sourceMappingURL=update-invoice-with-acceptance.js.map