...
const MyComms = require("./axios-comms");
...
exports.addParticipant = functions
    ...
    async function prepareDebugWallet(accountID, wallet) {
        console.log("prepareDebugAccount: creating Stellar DEBUG account and begging for XLM ########");
        try {
            requestor.get({
                ...
                if (mResponse.statusCode === 200) {
                    console.log("### MAJOR SUCCESS!!! ### FriendBot has given 10,000 XLM to " +
                        accountID +
                        " on Stellar. ####");
                    wallet.success = true;
                    ...
                    handleError("wallet failed, response code from Stellar: " +
                        mResponse.statusCode);
                    return null;
                }
            });
    ...
    async function writeWalletToFirestore(wallet) {
        admin
            ...
            console.log(result);
            console.log("########## Everything seems OK, sending result and status 200. Elapsed seconds: " +
...
//# sourceMappingURL=add_participant.js.map