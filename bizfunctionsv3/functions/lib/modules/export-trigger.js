...
exports.exportData = functions
    ...
    async function exportFirestoreData() {
        ...
        try {
            node_firestore_import_export_1.firestoreExport(collectionRef).then(data => {
    ...
    async function testOfferQuery() {
        ...
        const msg1 = `offers query, no conditions, found ${qs1.docs.length} elapsed ${end1 - start} milliseconds`;
        ...
        const msg2 = `offers query, limit = 100, found ${qs2.docs.length} elapsed ${end2 - end1} milliseconds`;
        ...
        const msg3 = `offers query, limit = 100, where isOpen = true, found ${qs3.docs.length} elapsed ${end3 - end2} milliseconds`;
        ...
        const msg4 = `offers query, limit = 100, where isOpen = true, where endTime = now, found ${qs4.docs.length} elapsed ${end4 - end3} milliseconds`;
        ...
        try {
            ...
            const msg5 = `offers query, where isOpen = true, where endTime = now, found ${qs5.docs.length} elapsed ${end5 - end4} milliseconds`;
        ...
        try {
            ...
            const msg6 = `offers query, where endTime = now, found ${qs6.docs.length} elapsed ${end6 - end5} milliseconds`;
        ...
        try {
            ...
            const msg7 = `offers query, where isOpen = true, found ${qs7.docs.length} elapsed ${end7 - end6} milliseconds`;
        ...
        try {
            ...
            const msg8 = `offers query, where isOpen = false, found ${qs8.docs.length} elapsed ${end8 - end7} milliseconds`;
...
//# sourceMappingURL=export-trigger.js.map