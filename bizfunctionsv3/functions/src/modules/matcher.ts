...
export class Matcher {
  static async match(
    profiles: Data.InvestorProfile[],
    orders: Data.AutoTradeOrder[],
    offers: Data.Offer[]
  ) {
    ...
    async function findInvestorMatch(
      ...
      for (const profile of profiles) {
        ...
        if (isValidBid) {
          ...
          console.log(
            "## valid execution unit created and added to list: " + units.length + ' invalid attempts: ' + invalidCount
          );
          return isValidBid;
        } else {
          invalidCount++;
    ...
    async function getInvestorBidTotal(profile: Data.InvestorProfile) {
      let querySnap;
